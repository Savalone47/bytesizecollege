      ...
      <div class="row">
         <div class="col-lg-8">
            <div class="course-details__content">
               ...
               <div class="course-details__content">
                  <ul class="course-details__tab-navs list-unstyled nav nav-tabs" role="tablist" style="display: flex !important;">
                     <li><a class="active" role="tab" data-toggle="tab" href="#description" aria-selected="false">Description</a></li>
                     <li><a class="" role="tab" data-toggle="tab" href="#overview" aria-selected="false">Modules</a></li>
                     <li><a class="" role="tab" data-toggle="tab" href="#curriculum" aria-selected="false">Prerequisite</a></li>
                  </ul>
                  <div class="tab-content course-details__tab-content ">
                     ...
                     <div class="tab-pane   animated fadeInUp" role="tabpanel" id="overview">
                        ...
                        <div class="course-details__price" style="background-color: transparent;">
                           <button type="button" class="btn btn-success btn-sm update" data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#register"
                              data-id="<?=$_GET['token'];?>"
                        ...
                        <div class="row mt-3">
                           ...
                           <div class="col-lg-12 col-md-12">
                              <ul class="lists lists-1">
                                 <li>1. Botswana General Certificate for Secondary Education (BGCSE), NCQF level 4, or equivalent qualification.</li>
                                 <li>2. Certificate III, NCQF level 3, with two years’ work experiences in related field</li>
                              </ul>
                              <h4>Access and Inclusion</h4>
                              <p>The qualification is accessible to anyone who is interested to pursue their career in the above mentioned fields of study. The admissions process will be open and transparent to all applicants. All learners are treated equally and fairly irrespective of their disability, age, gender, ethnic background, religious or philosophical belief, age, marital or parental status or socio-economic class to gain admission.</p>
                           </div>
                        </div>
                        <?php }elseif ($rom['courseCode'] == 1003) {?>
                        <div class="row mt-3">
                           <div class="col-lg-12 col-md-12">
                              <p>To be admitted into Certificate in Early Childhood Education, the following entry requirements are developed:</p>
                              <h4>Entry Requirements:</h4>
                           </div>
                           <!-- Buttons Styles -->       
                           <div class="col-lg-12 col-md-12">
                              <ul class="lists lists-1">
                                 <li>1. NCQF Level 4, Certificate IV, or equivalent, with a Credit in at least 3 subjects including English Language. </li>
                                 <li>2. Junior Certificate school leavers who are currently teaching in pre-schools to be admissible to the qualification through RPL.</li>
                                 <li>3. Experience in Pre-school teaching and early childhood care will be an added advantage. </li>
                              </ul>
                              <h4>Access and Inclusion</h4>
                              <p>The program is accessible to anyone interested to pursue their career in the field of early childhood education. The admissions process will be open and transparent for all applicants. All learners are treated equally and fairly irrespective of their disability, age, gender, ethnic background, religious or philosophical belief, age, marital or parental status, or socio-economic class to gain admission.</p>
                           </div>
                        </div>
...
<script>
   ...
   $(document).on('submit', '.submitForm', function(e){
               ...
               success:function(data){
                ...
                if(data == 200){
                 alert("Congratulations your application has been received an email has been sent to confirm the receiving of your application");
   
                }else if(data == 202){
   
                 alert("Your email address already being used please use another!");
                 ...
                 alert("Please make sure you have choosen a course and Department");
            ...
            <div class="modal-body" style="padding: 1rem 2rem;">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
                        <div class="col-sm-12">
                           <label><strong>SPONSORS/NEXT OF KIN DETAILS (A PERSON TO BE CONTACTED IN CASE OF EMERGENCY)</strong></label>                        
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <span class="font-12">&nbsp;&nbsp;Do you consider yourself to have a disability, impairment or long-term condition?<span style="font-size: 10px;">(Please tick)</span> &nbsp; &nbsp;<label class="checkbox-inline">yes
               ...
               <div class="row">
                  <div class="col-md-12">
                     <span class="font-12">I,</span> <input type="text" name="signature"  class="border-bottom"><span class="font-12">do bind myself in payment for</span> <span><input type="text" name="program" id="name_course" class="border-bottom" readonly></span><span class="font-12">Tuition and examination fees at this institution. I also agree that I have read and understood the contents of the above policies.
