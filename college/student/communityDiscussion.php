...
$sql = "SELECT * FROM community where  moduleID='".$_GET['id']."'";
...
<?php 
         ...
         <span><?php echo $text; ?></span>
          ...
          <?php if($imageFileType == 'pdf'){?>
                      <a href="../chats/<?php echo $row['discussion']?>" preview target="_blank"> <span class="img"><p class="filleName"><?php echo $row['discussion']?></p><img src="pdf.svg"></span></a>
                               ...
                               <?php }elseif($imageFileType == 'docx' || $imageFileType == 'doc' ){?>
                                    <a href="../staff/previewCommunity.php?preview=<?php echo $row['discussion']?>" target="_blank" preview>
