...
<div class="page-wrapper">
    ...
    border-radius: 0;">
							...
							<div class="card-body ">
								...
								$sql = "SELECT * FROM examReply where moduleID='".$_GET['id']."' and studentID='".$_SESSION['adminID']."'";
											...
											<div class="card card-box">
												<div class="card-body no-padding ">
													<div class="doctor-profile">
														...
														<a href="../img/<?php echo $row['exam']?>" preview>	<div class="profile-usertitle">
													...
													<?php }elseif($imageFileType == 'jpeg' || $imageFileType == 'jpg' || $imageFileType == 'png'){?>
															...
															<img src="../img/<?php echo $row['exam']?>"> 
																
																<?php }?>

															</div>
															<div class="name-center">
																<?php echo $row['exam']?><br>
