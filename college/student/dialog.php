...
<body
  ...
  flex-direction: column-reverse;">
                ...
                <div class="card-footer" style="display: flex;">
                  <form  action="sendMessage.php" method="POST" enctype="multipart/form-data" name="myForm" id="myForm" style="width: 90%">
...
function(){
      ...
      $('#load').load('chatting.php?id=<?php echo $_GET['id']?>&moduleID=<?php echo $_GET['moduleID']?>').fadeIn('slow');
