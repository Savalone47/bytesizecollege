								...
								<div class="card-body ">
									<div class="mdl-tabs mdl-js-tabs">
										<div class="mdl-tabs__tab-bar tab-left-side">
											<a href="#tab4-panel" class="mdl-tabs__tab is-active">Notifications</a>
										...
										<div class="mdl-tabs__panel is-active p-t-20" id="tab4-panel">
											<div class="row">
												...
												$sql ="SELECT * FROM notification LIMIT ".$offset.", ".$total_records_per_page.""; 
																...
																<?php if($_SESSION['adminLevel'] =='1' || $_SESSION['adminLevel'] =='2' ){?>
																	<div class="card-head">
																		...
																		<li class="mdl-menu__item">
																			<a onclick="return confirm('Are you sure you want to delete this?')" href="back/deleteNotification.php?code=gfhhjhkjkjkjkjkjkjkjkjkjkjkuiuiuiuiuiuiuiuiuiuiuiuiuiuiuiuiuiuiui&id=<?php echo $row['id'];?>"><i class="material-icons">delete</i>Delete</a>
																		</li>
																...
																<div class="">
																	...
																	<div class="card-body no-padding ">
																		<div class="doctor-profile">
																			...
																			<span class="notification-icon circle deepPink-bgcolor"><i class="fa fa-bell" aria-hidden="true"></i></span>
...
<?php
	...
	echo "<script> alert('Error! Please login first');
