...
<body
	...
	<div class="page-wrapper">
      ...
      ?>
								...
								<div class="page-title" style="text-align: center;padding: 0 !important; margin: 0 !important;"><?php echo $numm['moduleName'];?>   Chapter(s)</div>
					...
					<div class="state-overview">
						<div class="row">
							...
							<?php 
								...
								$sql ="SELECT * FROM topics where moduleID='".$_GET['id']."' and deleteStatus=0 and status=1";
                 ...
                 $colors = array("green","blue","yellow");
                  ...
                  $random_keys = array_rand($colors,2);
							...
							<!---subject start--> 
							<div class="col-xl-4 col-md-6 col-12" data-toggle="modal" data-target="#slide-left">
								<a href="classes.php?id=<?php echo $_GET['id']?>&chapter=<?php echo $row['id']?>" class="card info-box  card-topline-aqua">
								<div class="">
               ...
               display: block;
                ...
                "><?php echo $row['topicName']?></p>
						...
						<?php }
												...
												echo "<p style='color:red;'>No chapter(s) available!</p>";
