	...
	$row1 = mysqli_fetch_array($query);
		...
		<div class="page-container">
			...
			ZhxoYwAAAABJRU5ErkJggg==" width="20" height="20" class="gwt-Image CCCX1UC-m-e" aria-hidden="true">Back</a>
								...
								<div class="page-title" style="text-align: center;margin: 0px !important;padding: 0px;"><?php echo $row1['moduleName']?></div>
...
$sql = "SELECT * FROM assignmentFeedback 
inner join assignment on assignmentFeedback.assignmentID = assignment.id
inner join modules on modules.moduleID = assignment.moduleID 

 where assignmentFeedback.moduleID ='".$_GET['id']."'
 and assignmentFeedback.studentID = '".$_SESSION['adminID']."'
 ";
							$query = mysqli_query($conn,$sql);
							...
							<div class="  card card-topline-aqua">
								...
								<div class="white-box">
									...
									<h6 style="color: #666;" class="" style="font-size: 16px !important; margin: 20px ;margin-left: 0px; ">Assignment <?php echo $row['assignmentNo']?></h6>
									<p style="color: #ff4081;"> <span style="font-size: 12px; font-weight: 100; font-style: italic;float: right;"></span> </p>
									<p style="color: #ff4081;">Marks:  <?php echo $row['total']?>/<?php echo $row['marks']?></p>

									<p style="color: #ff4081;">View Feedback:  &nbsp;
								<?php
									if($imageFileType == 'doc' || $imageFileType == 'docx' ){
									echo "<a href='../staff/previewReplies.php?preview=".$row['feedback']."'>".$row['feedback']."</a>";
								 } else{

									echo "<a href='../../management/img/".$row['feedback']."'>".$row['feedback']."</a> </p>";

								}
									?>
												
									<p style="color: #ff4081;">Module Name: <?php echo $row['moduleName']?></p>
									<p style="color: #ff4081;">Assignment No: <?php echo $row['assignmentNo']?></p>
