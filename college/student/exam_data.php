...
if(secure($_SESSION['adminID']) && secure($_SESSION['adminName']) && secure($_SESSION['adminEmail'])){
	...
	<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-indigo"  >
		...
		<div class="page-wrapper">
			...
			ZhxoYwAAAABJRU5ErkJggg==" width="20" height="20" class="gwt-Image CCCX1UC-m-e" aria-hidden="true">Back</a>
						...
						<div class="page-title" style="text-align: center;margin: 0; padding: 0;"> My Exams</div>
	...
	<?php 
							...
							<div class="row">
								...
								<div class="col-md-4">
									<a href="exam_results.php?id=<?php echo $_GET['id']?>">
											...
											<div class="card-body no-padding ">
												<div class="doctor-profile">
													...
													<div class="profile-usertitle">
														...
														<div class="doctor-name"><i class="material-icons"></i>Exam Results</div>
								...
								<?php 
									...
									$sql ="SELECT * FROM exam where moduleID = '".$_GET['id']."'";
									...
									<div class="col-md-4">
										<div class="card card-topline-aqua">
											<div class="card-body no-padding ">
												<a href="../../management/img/<?php echo $row['exam']?>" download style="font-size:11px;"><i class="fa fa-cloud-download" style="color: #3ac9d6"></i>download</li></a>
		...
		$row10 = mysqli_fetch_array($query10);
										...
										<div class="doctor-name txt " style="font-size: 12px;text-align: left;"><?php echo $row['title']?></div>
										<div class="name-center" style="font-size: 10px;text-align: left;">Exam Date: <span style="float: right"><?php echo date('d-F-Y',strtotime($row['date'])) ?> </span>
										</div>
										<div class="name-center" style="font-size: 10px;text-align: left;">Exam Start-Time: <span style="float: right;"><?php echo date('H:i',strtotime($row['start'])) ?></span>  </div>
										<div class="name-center" style="font-size: 10px;text-align: left;">Exam End-Time: <span style="float: right;"><?php echo date('H:i',strtotime($row['end'])) ?></span>  </div>

										<div class="name-center" style="font-size: 10px;text-align: left;">Submission status: <span style="float: right;"><?php
										 if($row10['studentID']){

												echo '<span style="color:green;font-size:9px;">Submitted!</span>';

											}else{

												echo '<span style="color:green;font-size:9px;">Pending!</span>';
											}
											...
											?></span>  </div>
												...
												<div class="profile-userbuttons">
													<?php
													$imageFileType = strtolower(pathinfo($row['exam'],PATHINFO_EXTENSION));
                                                    if ($imageFileType == 'docx' || $imageFileType == 'doc' ) {
													echo '<a href="../staff/previewExams.php?preview='.$row['exam'].'" preview><button class="btn btn-success btn-xs">View Exam</button></a>';
												}else{
													echo '<a href="../staff/exams/'.$row['exam'].'" preview><button class="btn btn-success btn-xs">View Exam</button></a>';
												}
												?>

													<button class="btn btn-success btn-xs" data-toggle="modal" data-target="#tab<?php echo $row['id']?>">Submit Exam</button>
