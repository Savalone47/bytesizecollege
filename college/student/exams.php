		...
		<div class="page-container">
           ...
           if($getROW['activeStatus'] =='1'){?>
				...
				<div class="row">
					...
					$sql="SELECT * 
					FROM  moduleAssign
					inner join modules on modules.moduleID = moduleAssign.moduleID 
					inner join courses on courses.coursesID = modules.moduleCourseID
					WHERE studentID='".secure($_SESSION['adminID'])."'";
					...
					$colors = array("bg-info","bg-success","bg-warning","bg-pink");
...
?>
							...
							<!---subject start--> 
								...
								<div class="col-xl-4 col-md-6 col-12" data-toggle="modal" data-target="#slide-left<?php echo $row['moduleID']; ?>">
								<a href="exam_data.php?id=<?php echo $row['moduleID']?>">
									<div class="<?php echo $colors[$card++];?> info-box ">
									<span class="info-box-icon "><img src="workspace.svg"></span>
									<div class="info-box-content">
