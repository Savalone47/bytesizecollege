...
$sql2 = "SELECT * FROM students where studentID='".secure($_SESSION['adminID'])."'";
                ...
                <div class="card-body" id="bar-parent">
                  ...
                  <table id="exportTable" class="display ">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM modules inner join moduleAssign on modules.moduleID = moduleAssign.moduleID where moduleAssign.studentID='".$_SESSION['adminID']."' ";
