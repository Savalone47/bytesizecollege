...
?>
           ...
           if($getROW['activeStatus'] =='1'){?>
										<?php 
										$sql ="SELECT * FROM notification LIMIT 5";
										$query = mysqli_query($conn, $sql);
										while($row = mysqli_fetch_array($query)){
										?>
										<li>
											<a class ="viewNot" data-id='<?php echo $row["id"]?>' href="view_notification.php?id=<?php echo $row['id']?>">
        ...
        echo "<p style='color:red'>Your account has not been activated yet!</p>";
						...
						<li class="dropdown dropdown-user">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
								data-close-others="true">
								<img alt="" class="img-circle " src="avatar.png"/>
								<span class="username username-hide-on-mobile"> <?php echo $_SESSION['adminName']?> </span>
...
$( ".badge" ).click(function() {
  $('.badge').hide();
    ...
    $(document).on('click', '.viewNot', function(){
