...
<body
  ...
  flex-direction: column-reverse;">
         ...
         <div class="card-footer" style="display: flex;">
                  <form  method="POST" enctype="multipart/form-data" name="myForm" id="myForm" style="width: 90%">
                    <div class="input-group" >
                          
                        <textarea rows='3' data-min-rows='3'  id=myTextArea name="text" type="text" class="form-control input-sm txt" placeholder="Type your message here..."  ></textarea>
                    </div>
                        </form>
...
if($imageFileType != "docx" && $imageFileType != "pdf") {
    echo "<p style='color:red;'>Sorry, only docx, pdf files are allowed.";
    $uploadOk = 0;
}
...
$sql2 ='INSERT INTO groupDiscuss(studentID,discussion,discussion2,chapter,moduleID) 
values("'.secure($_SESSION['adminID']).'",
"'.basename( secure($_FILES["img"]["name"])).'",
"'.secure($_POST['text']).'",
"'.secure($_GET['id']).'",
"'.secure($_GET['moduleID']).'")';
...
$('#load').load('groupDiscussion.php?id=<?php echo $_GET['id']?>&moduleID=<?php echo $_GET['moduleID']?>').fadeIn('slow');
