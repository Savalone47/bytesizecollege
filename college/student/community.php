...
<body
  ...
  <div class="page-wrapper">
    ...
    <div class="page-container">
      ...
      <span style="float: right;margin-top: 4rem">Community</span>
          <br><br>
          <div class="row ">
...
$sql2="INSERT INTO community(studentID,discussion2,moduleID) 
...
$('#load').load('communityDiscussion.php?id=<?php echo $_GET['id']?>').fadeIn('slow');
