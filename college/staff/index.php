			...
			<div class="page-content-wrapper">
				...
				$getSql = "";
                          ...
                          $result_count = mysqli_query(
                            $conn,
                            "SELECT COUNT(*) As total_records FROM lectureAssigns
...
?>
							...
							<!---subject start--> 
							<div class="col-xl-4 col-md-6 col-12" data-toggle="modal" data-target="#slide-left<?php echo $checkRow['moduleID']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="slide-left<?php echo $checkRow['moduleID']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
