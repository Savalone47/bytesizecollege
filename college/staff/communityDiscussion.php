    ...
    <li class="admin clearfix">
      ...
      <div class="chat-body clearfix" style=" background-color: rgba(101, 93, 254, 0.8); color: white;">
       ...
       <?php if($imageFileType == 'pdf'){?>
        <a href="../chats/<?php echo $row['discussion']?>" preview> <span class="img"><p class="filleName"><?php echo $row['discussion']?></p><img src="pdf.svg"></span></a>
      <?php }elseif($imageFileType == 'mp4'){?>
       ...
       <?php }elseif($imageFileType == 'docx' || $imageFileType == 'doc' ){?>
        <a href="previewCommunity.php?preview=<?php echo $row['discussion']?>" preview>
