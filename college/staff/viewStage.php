                    ...
                    <div class="col-md-12">
                        ...
                        <div class="profile-content">
                                            ...
                                            <div class="table-scrollable">
                                                <table
                                                    ...
                                                    while ($row1 = mysqli_fetch_array($result1)) {
                                                        ...
                                                        <!-- edit module modal -->
                                                        <div class="modal slide-left" id="teacher<?php
                                                        echo $row1['moduleID'] ?>" tabindex="-1" role="dialog"
                                                             aria-labelledby="Warning Modal">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content modal-info">
                                                                    <div data-dismiss="modal"><i class="fa fa-times"
                                                                                                 style="color: red; float: right;"
                                                                                                 data-dismiss="modal"></i>
                                                                    </div>
                                                                    <form action="back/editTeacher.php" method="POST"
							...
							from  management";
                                                                                    ...
                                                                                    while ($row12 = mysqli_fetch_array(
                                                                                        $query12
                                                                                    )) {
                                                                                        ?>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td data-toggle="modal" data-target="#module<?php
                                                            echo $row1['moduleID']; ?>">

                                                                <a href="#" data-toggle="modal"
                                                                   data-target="module"><?php
                                                                    echo $row1['moduleName']; ?></a>
                                                            </td>

                                                            <td><a href="viewProfile.php?id=<?php
                                                                echo $row1['managementID']; ?>"><?php
                                                                    echo $row1['managementName']; ?></a></td>
                                                            <td>
                                                                <?php
                                                                if ($_SESSION['adminLevel'] == '1' || $_SESSION['adminLevel'] == '2') { ?>
                                                                    ...
                                                                    <a onclick="return confirm('Are you sure you want to delete this?')"
                                                                       href="back/removeModule.php?id=<?php
                                                                       echo $row1['moduleID'] ?>">
                                                                ...
                                                                <button class="btn btn-success" data-toggle="modal"
                                                                        data-target="#add<?php
                                                                        echo $row1['moduleID'] ?>">Add student
                                                                </button>
                                                        ...
                                                        <div class="modal fade show" id="module<?php
                                                        echo $row1['moduleID']; ?>" tabindex="-1" role="dialog"
                                                                ...
                                                                <div class="modal-content" style="padding: 1rem">
                                                                    ...
                                                                    <div class="state-overview">
                                                                        <div class="row">
                                                                                ...
                                                                                echo $row1['moduleID'] ?>">
                                                                                    <div class="info-box purple">
                                                                                        ...
                                                                                        <span class="info-box-text"
                                                                                              style="color: #fff;">Community</span>
                                                                            ...
                                                                            <!-- /.col -->
                                                                            <div class="col-xl-6 col-md-6 col-12">
                                                                                <a href="my_assignment.php?id=<?php
                                                                                echo $row1['moduleID'] ?>">
                                                                                    <div class="info-box bg-b-blue">
                                                                                        ...
                                                                                        <span class="info-box-text"
                                                                                              style="color: #fff;">Assignments</span>
                                                                            ...
                                                                            <div class="col-xl-6 col-md-6 col-12">
                                                                                ...
                                                                                echo $row1['moduleID'] ?>">
                                                                                    <div class="info-box bg-b-yellow">
                                                                                        ...
                                                                                        <span class="info-box-text"
                                                                                              style="color: #fff;">Resources</span>
                                                                            ...
                                                                            <div class="col-xl-6 col-md-6 col-12">
                                                                                <a href="students.php?moduleID=<?php
                                                                                echo $row1['moduleID'] ?>">
                                                                                ...
                                                                                <a data-dismiss="modal"
                                                                                   ...
                                                                                   echo $row1['moduleID'] ?>">
                                                                                    <div class="info-box bg-b-pink">
                                                                                        ...
                                                                                        <span class="info-box-text"
                                                                                              style="color: #fff;">Change Teacher</span>
                                                        ...
                                                        <div class="modal slide-left addStudentHere" id="add<?php
                                                        echo $row1['moduleID'] ?>" tabindex="-1" role="dialog"
                                                             aria-labelledby="Warning Modal">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content modal-info">
                                                                    ...
                                                                    <form class="addStudent"
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="card-body row">
                                                                                <div class="col-lg-12"
                                                                                     style="text-align: center; color: #888">
                                                                                    <p>Add Student to <?php
                                                                                        echo $row1['moduleName'] ?> </p>
                                                                                </div>
                                                    ...
                                                    <div class="card-body no-padding ">
                                                        <div class="doctor-profile">
                                                            ...
                                                            <div class="profile-usertitle">
                                                                <div class="doctor-name"><?php
                                                                    echo $row2['studentName']; ?></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="profile-userbuttons">
                                                                <a href="studentProfile.php?id=<?php
                                                                echo $row2['studentID'] ?>"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>If you have selected 'yes' please provide the name(s) of your other
                                        child/children below</label>
            ...
            <form class="createSubject" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body row">
                        ...
                        echo $courseName; ?>">
                        <input type="hidden" name="departmentName" value="<?php
                        echo $departmentName; ?>">


                        <div class="col-lg-12 p-t-20">
                            <input type="hidden" name="courseID" class="mdl-textfield__input" value="<?php
                            echo $_GET['id']; ?>">
