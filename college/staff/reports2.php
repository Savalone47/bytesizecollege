              ...
              <div class="col-xl-4 col-md-6 col-12">
                ...
                <div class="info-box bg-b-green" style="color: #fff;">
                  ...
                  <div class="info-box-content">
                    ...
                    <div class="progress">
                      <div class="progress-bar" style="width: <?=$num/100*400;?>%"></div>
                    </div>
              ...
              <div class="col-xl-4 col-md-6 col-12">
                ...
                <div class="info-box bg-b-yellow" style="color: #fff;">
                  ...
                  <div class="info-box-content">
                    ...
                    <?php
                      $sql_course = mysqli_query($conn,"SELECT courseCode,courseName FROM courses Group by courseCode");

                              $course = mysqli_num_rows($sql_course);
                                                                      
                    ?>
                    <span class="info-box-text"> Students Per Course</span>
                    <span class="info-box-number"><?=$course;?> courses</span>
                    <div class="progress">
                ...
                <div class="info-box bg-b-" style="background-color: #8E44AD !important; color: #fff;">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text" >Staff Login</span>
                     <?php
                      $sql_branch = mysqli_query($conn,"SELECT * FROM userlog INNER JOIN management ON management.managementID = userlog.userID");
                ...
                <div class="info-box bg-b-" style="background-color: #e91e63 !important; color: #fff;">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text" >Student Login</span>
                     <?php
                      $sql_branch = mysqli_query($conn,"SELECT * FROM userlog INNER JOIN students ON students.studentID = userlog.userID");
