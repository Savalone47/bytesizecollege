				...
				<a href="" class="backbtn" onclick="history.go(-1); return false;"><img src="data:image/png;base64,iVBORw0K
					...
					<div class="row">
						...
						<div class="col-md-10">
							...
							<button class="btn btn-info pull-right btn-xs" data-toggle="modal" data-target="#tab3">Upload Material</button>
	...
	<div class="modal slide-left" id="tab3" tabindex="-1" role="dialog" aria-labelledby="Warning Modal">
						<div class="modal-dialog" role="document">
							<div class="modal-content modal-info">
								<div><i class="fa fa-times" style="color: red; float: right;" data-dismiss="modal" ></i></div>
								<div class="modal-body">
									<form action="assignmentMaterial.php" method="POST" enctype="multipart/form-data">
										<div class="card-body row">
											<div class="col-lg-12" style="text-align: center; color: #888">
												<p>Add Resource</p>
											</div>
											...
											<div class="card card-box">
													...
													<div class="doctor-profile">
															...
															<div class="doctor-name">
																...
																if($imageFileType == 'pdf'){ ?>
																	<img src="pdf.svg"> 
												<a href="assignment/<?php echo $row['file']?>" preview target="_blank">
												...
												<a href="assignment/<?php echo $row['file']?>" preview target="_blank">
																<?php }elseif($imageFileType == 'doc' || $imageFileType == 'docx' ){?>
																	...
																	<img src="word.svg"> 
												<a href="previewAssignment.php?preview=<?php echo $row['file']?>" preview target="_blank">
												...
												<a href="assignment/<?php echo $row['file']?>" preview target="_blank">
															...
															<div class="profile-userbuttons">
																<form action="delete_assignment.php" method="POST" enctype="multiple/form-data">
																<input type="hidden" name="delete" value="<?php echo $row['fileID']?>">
