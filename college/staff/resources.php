      ...
      ZhxoYwAAAABJRU5ErkJggg==" width="20" height="20" class="gwt-Image CCCX1UC-m-e" aria-hidden="true">Back</a>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-6"><?php echo $row2['courseName'] ?>
                                &nbsp;&nbsp;&nbsp;<span><?php echo $row1['moduleName']; ?></span></div>
                    ...
                    <div class="modal slide-left" id="tab" tabindex="-1" role="dialog" aria-labelledby="Warning Modal">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-info">
                                <div><i class="fa fa-times" style="color: red; float: right;" data-dismiss="modal"></i>
                                </div>
                                <form action="back/createChapter.php" method="POST">
                                    <div class="modal-body">
                                        ...
                                        <div class="card-body row">
                                            ...
                                            <input class="mdl-textfield__input" type="hidden" name="moduleID"
                                            ...
                                            <div class="col-lg-12 p-t-20">
                                                <div
                                                    ...
                                                    <input class="mdl-textfield__input" name="chapter" type="text"
                                                           id="txtFirstName" required>
                                ...
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <div class="col-lg-3 col-md-6  col-8">
                                        <a href="view_resources.php?id=<?php echo $row['id'] ?>">
                                            ...
                                            <img alt="" src="folder.svg" style="height: 3rem;"> <span
                                                    style="font-size: 10px; font-style: italic;color: #919aa3!important; font-weight: 200 "><?php echo date('d-F', strtotime($row['time_stamp'])) ?></span>
                                            <br>
