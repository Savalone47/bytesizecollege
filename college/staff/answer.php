...
//Check if file is uploaded
		...
		where id='".$_POST['examID']."' ";
				...
				<div class="row">
					...
					<?php 
				 $sql = "SELECT * FROM examAnswer where moduleID='".$_GET['id']."'";
					...
					while($row = mysqli_fetch_array($query)){
						...
						<div class="col-md-4">
							...
							<a href="back/deleteAnswer.php?message=afjfmjgjdhgasdjhgsmhgsdjhgdfdfgdvdgfdhfgdjfhdgfjhdhhdhfgdhgfdhfgdhfgdhfgdhfgdhfgdhgfdhgfhdgfhdgfd&id=<?php echo $row['answerID'];?>"> <li class="mdl-menu__item"><i class="material-icons">delete</i>Delete
										</li></a>
								...
								<div class="doctor-name txt" style="font-size: 15px"> <?php echo $row['examName'];?> </div>
										...
										<div class="profile-userbuttons">
                                         ...
                                         $imageFileType = strtolower(pathinfo($row['answer'],PATHINFO_EXTENSION));
											...
											echo '<a href="previewAnswerSheet.php?preview='.$row["answer"].'"
											class="btn btn-circle -sm" target="_blank"><i class="fa fa-eye"></i> View</a>';
											
										}else{
											

											echo '<a href="exams/'.$row['answer'].'"
											class="btn btn-circle -sm" preview><i class="fa fa-eye"></i> View</a>';
										}
										?>
											<?php if($row['activeStatus']==0){?>
											<a href="back/statusAnswer.php?id=<?php echo $row['answerID']?>&stat=0"
											class="btn btn-circle bg-danger btn btn-sm"><i class="fa fa-toggle-off"></i> Deactivated</a>
										<?php }else{?>

										<a href="back/statusAnswer.php?id=<?php echo $row['answerID']?>&stat=1"
											class="btn btn-circle bg-success btn btn-sm"><i class="fa fa-toggle-on"></i> Activated</a>
			...
			<!-- create exam modal -->
				...
				<form action="back/editAnswer.php" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="card-body row">
						<div class="col-lg-12" style="text-align: center; color: #888">
							<p>Edit Answer sheet</p>
						</div>
						<div class="col-lg-12 p-t-20">
							<br><input type="text" name="examName"  value="<?php echo $row['examName']?>" class="mdl-textfield__input" >
							<label class="mdl-textfield__label" style="margin-left: 1rem">Exam Name</label>
							<br>
							<br>
							<input type="hidden" name="id" value="<?php echo $row['answerID']?>">
				...
				<br>
				<input class="mdl-textfield__input" type="file" value="<?php echo $row['answer']?>" id="txtFirstName" name="file" accept=".pdf">
...
<div class="modal-footer">
	<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink">Save</button>
</div>
...
<div class="modal slide-left" id="exam1" tabindex="-1" role="dialog" aria-labelledby="Warning Modal">
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-info">
			<form action="back/uploadAnswer.php" method="POST" enctype="multipart/form-data">
				<div><i class="fa fa-times" style="color: red; float: right;" data-dismiss="modal" ></i></div>
				<div class="modal-body">
					...
					<div class="card-body row">
						...
						<div class="col-lg-12 p-t-20">
							<br><input type="text" name="examName"  class="mdl-textfield__input" >
							<label class="mdl-textfield__label" style="margin-left: 1rem">Exam Name</label>
							<br>
							<br>
				...
				<div
				class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
				<br><input class="mdl-textfield__input" type="file" id="txtFirstName" name="file" accept=".pdf">
				<label class="mdl-textfield__label">Upload Document</label>
			</div>
		</div>
