...
<?php  if(secure($_SESSION['adminLevel']) == "1" || secure($_SESSION['adminLevel']) == "2" || secure($_SESSION['adminLevel']) == "5" ){ ?>
	...
	if(secure($_SESSION['adminLevel']) == "1" || secure($_SESSION['adminLevel']) == "2" || secure($_SESSION['adminLevel']) == "5"   ){ ?>
														...
														<button id="panel-button<?php echo $row['eventID'];?>"
														class="mdl-button mdl-js-button mdl-button--icon pull-right"
														data-upgraded=",MaterialButton">
														<i class="material-icons">more_vert</i>
													</button>
													<ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
													data-mdl-for="panel-button<?php echo $row['eventID'];?>">

													<li class="mdl-menu__item" data-toggle="modal" data-target="#edit<?php echo $row['eventID'];?>"><i class="material-icons">edit</i>Edit
													</li>			

													<li class="mdl-menu__item"><a onclick="return confirm('Are you sure want to delete event');" href="back/deleteEvent.php?code=<?php echo bin2hex($token);?>&id=<?php echo $row['eventID'];?>"><i class="material-icons">delete</i>Delete</a>
													</li>
					...
					<?php } ?>
											...
											<!-- END -->
													<img src="events/<?php echo $row['eventImage'];?>" class="doctor-pic"
													alt="">
			...
			<!--===================edit modal start==========-->
<div class="modal slide-left" id="edit<?php echo $row['eventID'];?>" tabindex="-1" role="dialog" aria-labelledby="Warning Modal">
	<div class="modal-dialog" role="document">
		<br>
		<div><i class="fa fa-times" style="color: red; float: right;" data-dismiss="modal" ></i></div>
		<div class="modal-content modal-info">
			<form action="back/editEvent.php" method="POST" enctype="multipart/form-data">

				<input class="mdl-textfield__input" name="eventID" type="hidden" id="txtFirstName" value="<?php echo $row['eventID'];?>">
					...
					<div class="card-body row">
						...
						<img src="events/<?php echo $row['eventImage'];?>" class="doctor-pic"
													alt="">
						<div class="profile-usertitle">
						<div class="doctor-name" style="height: 3.5em; overflow: hidden;">
							<input class="mdl-textfield__input" name="eventName" type="text" id="txtFirstName" value="<?php echo $row['eventTitle'];?>">
							...
							<br>
							<input class="mdl-textfield__input" name="date" type="date" id="txtFirstName" value="<?php echo $row['eventDate'];?>">
							<label class="mdl-textfield__label">Event Date</label>
						</div>

						<div
						class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						<br><input class="mdl-textfield__input" type="time" id="txtFirstName" name="eventstatTime" value="<?php echo $row['eventstatTime'];?>">
						<label class="mdl-textfield__label">Event Start Time</label>
					</div>

					<div
					class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					<br><input class="mdl-textfield__input" type="time" id="txtFirstName" name="endtime" value="<?php echo $row['eventendTime'];?>">
				...
				class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
				<br>
				<textarea class="mdl-textfield__input"  rows="4" name="eventLocation"><?php echo $row['eventLocation'];?></textarea>
			...
			class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
			<br>
			<textarea class="mdl-textfield__input" rows="4"  name="eventDescription"><?php echo $row['eventDescription'];?></textarea>
...
<div class="modal-footer">
	<button 
	class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-info">Update</button>
</div>
...
<div class="modal slide-left" id="tab2" tabindex="-1" role="dialog" aria-labelledby="Warning Modal">
	<div class="modal-dialog" role="document">
		...
		<div><i class="fa fa-times" style="color: red; float: right;" data-dismiss="modal" ></i></div>
		<div class="modal-content modal-info">
			<form action="back/createEvent.php" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="card-body row">
						...
						<div
						class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						<br><input class="mdl-textfield__input" type="time" id="txtFirstName" name="start" required="">
						<label class="mdl-textfield__label">Event Start Time</label>
					</div>

					<div
					class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					<br><input class="mdl-textfield__input" type="time" id="txtFirstName" name="end" required="">
					<label class="mdl-textfield__label">Event End Time</label>
				</div>
			...
			class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
			<br>
			<textarea class="mdl-textfield__input" rows="4" name="description" id="text7"></textarea>
			<label class="mdl-textfield__label">Event Description</label>
		</div>
...
<div class="modal-footer">
	<button 
	class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-info">Create</button>
</div>
