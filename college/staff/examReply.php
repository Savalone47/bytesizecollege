	...
	<div class="page-wrapper">
      ...
      ZhxoYwAAAABJRU5ErkJggg==" width="20" height="20" class="gwt-Image CCCX1UC-m-e" aria-hidden="true">Back</a>
					<div class="row">
						<div class="col-md-12">
							<div class=" pull-left">
								<div class="page-title">Exam Replies</div>
							</div>
						...
						<div class="col-md-12 col-sm-12">
							...
							<div class="card card-topline-aqua">
									...
									<div class="table-scrollable">
										<table class="table">
											...
											<tbody>
												...
												$sql="SELECT * 
												FROM  examReply
												inner join exam on exam.id =  examReply.examID
												inner join students on students.studentID = examReply.studentID

												WHERE 	examID = '".secure($_GET['id'])."'";
													...
													while($row = mysqli_fetch_array($result)){
														...
														<tr class="active">
															...
															<td>
																...
																$getSqli = "SELECT * FROM examFeedback where studentID='".$row['studentID']."' and examID='".$_GET['id']."' limit 1";
																...
																if($getNum > 0){
																	...
																	echo "<button class='btn bg-success btn-xs'>Unavalaible</button>";
															...
															<td>
																...
																$getSqli = "SELECT * FROM examFeedback where studentID='".$row['studentID']."' and examID='".$_GET['id']."'";
																$getQuery = mysqli_query($conn, $getSqli);
																$getNum = mysqli_num_rows($getQuery);
																if($getNum > 0){
								...
								<!--<iframe src="https://docs.google.com/gview?url=https://sagan.columnaeducation.com/HS/management/img/
									...
									<hr/>
									<?php
									$sqlite = "SELECT * FROM examReply where studentID='".$row['studentID']."' and examID='".$_GET['id']."'";
									...
									while ($rowlite = mysqli_fetch_array($querylite)) {
										...
										if ($imageFileType == 'docx' || $imageFileType == 'doc' ) {
											echo '<a href="previewExam.php?preview='.$rowlite["exam"].'">'.$rowlite["exam"].'</a>';
										}else{
										
										echo '<a href="examReply/'.$rowlite["exam"].'">'.$rowlite["exam"].'</a>';
									}
									?>
										<br/>
									<?php }?>
									...
									Reply
									<hr/>
									<form action="reply_exam.php" method="POST" enctype="multipart/form-data" >
										...
										<input type="file" class="mdl-textfield__input" name="img" >
