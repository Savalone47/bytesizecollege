...
<body
  ...
  <div class="page-wrapper">
    ...
    <div class="page-container">
      ...
      ZhxoYwAAAABJRU5ErkJggg==" width="20" height="20" class="gwt-Image CCCX1UC-m-e" aria-hidden="true">Back</a>
                       ...
                       <?php
          $sqlite = "SELECT * FROM topics where id='".$_GET['id']."'";
          $querylite = mysqli_query($conn,$sqlite);

          $rowlite = mysqli_fetch_array($querylite);

          echo "<span >".$rowlite['topicName']."</span>";?>
  ...
  flex-direction: column-reverse;">
          ...
          <div class="card-footer">
                  ...
                  <form action="chapterMessage.php" method="POST" enctype="multipart/form-data" name="myForm" id="myForm">
