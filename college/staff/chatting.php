...
include "../action.php";
 ...
 $sql = "SELECT * FROM discussion where moduleID='".$_GET['moduleID']."' 
and studentID='".$_GET['id']."' 
and facilitatorID ='".$_SESSION['adminID']."'";
...
?>
								...
								?>
                                        ...
                                        $sql5 = "SELECT * FROM management where managementID='".$_SESSION['adminID']."'";
    ...
    .img .filleName{
      ...
      text-decoration: underline;
                    ...
                    <small class="right primary-font" style="color: #fff"><?php echo $_SESSION['adminName']?></small>
                               ...
                               <a href="../chats/<?php echo $row['discussion']?>" preview target="_blank"> <span class="img"><?php echo $row['discussion']?><img src="pdf.svg"></span></a>
                               <?php }elseif($imageFileType == 'mp4'){?>
                                  <a href="../chats/<?php echo $row['discussion']?>" preview target="_blank">
                        ...
                        <li class="agent clearfix">
                            ...
                            <div class="chat-body clearfix" style="background-color: rgb(234,238,243);">
                             ...
                             <span class="chat-img left clearfix mx-2">
                                <img src="../student/avatar.png" alt="Agent" class="img-circle" />
                            </span>
                        </li>
