				...
				<div class="card-body ">
					...
					<?php if($_SESSION['adminLevel'] == '1' || $_SESSION['adminLevel'] == '2'){ ?>
							<div class="card-head">
								...
								<button id="panel-button<?php echo $row['departmentID'];?>"
									class="mdl-button mdl-js-button mdl-button--icon pull-right"
									data-upgraded=",MaterialButton">
									<i class="material-icons">more_vert</i>
								</button>
								<ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
								data-mdl-for="panel-button<?php echo $row['departmentID'];?>">

								<li class="mdl-menu__item" data-toggle="modal" data-target="#tab<?php echo $row['departmentID'];?>"><i class="material-icons">edit</i>Edit
								</li>			

								<li class="mdl-menu__item">
									<a onclick="return confirm('Are you you sure you want to delete this?')" href="back/deleteDepartment.php?id=<?php echo $row['departmentID'];?>&department=<?php echo $row['departmentName']?>"><i class="material-icons">delete</i>Delete</a>
								</li>
					...
					<?php } ?>
						...
						<!-- end control -->
						<a href="allClasses.php?id=<?php echo $row['departmentID'];?>">
							<div class="">
								...
								<div class="card-body no-padding ">
									<div class="doctor-profile">
										<?php if($row['departmentID'] == 23){ ?>
										<img src="../../assets/images/Gaborone.jpg" class="doctor-pic" alt="">
										<?php }elseif($row['departmentID'] == 24){ ?>
										<img src="../../assets/images/Palapye.jpg" class="doctor-pic" alt="">
										<?php }elseif($row['departmentID'] == 25){ ?>
										<img src="../../assets/images/Letlhakane.jpg" class="doctor-pic" alt="">
										<?php }elseif($row['departmentID'] == 32){ ?>
										<img src="../../assets/images/Online School.jpg" class="doctor-pic" alt="">
										<?php }elseif($row['departmentID'] == 33){ ?>
										<img src="../../assets/images/Gaborone.jpg" class="doctor-pic" alt="">
										<?php }elseif($row['departmentID'] == 34){ ?>
										<img src="../../assets/images/Palapye.jpg" class="doctor-pic" alt="">
										<?php }elseif($row['departmentID'] == 35){ ?>
										<img src="../../assets/images/Letlhakane.jpg" class="doctor-pic" alt="">
										<?php }?>
										
										<div class="profile-usertitle">

											<div class="name-center"><?php echo $row['departmentName']?> </div>
										</div>
					...
					<!-- Edit class modal -->
					<div class="modal slide-left editModal" id="tab<?php echo $row['departmentID'];?>" tabindex="-1" role="dialog" aria-labelledby="Warning Modal">
									...
									<div class="modal-body">
										...
										<div class="card-body row">
											...
											<input type="hidden" name="id" value="<?php echo $row['departmentID'];?>">
												<input type="text" name="departmentName"  class="mdl-textfield__input" value="<?php echo $row['departmentName']?>">
												<!-- <label class="mdl-textfield__label" style="margin-left: 1rem">Department Name</label> -->
												<br>
												<br>
<input type="hidden" name="previousName" value="<?php echo $row['departmentName']?>">
												

											<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<br>
												<select class="mdl-textfield__input" name="hodManager">
							<option value="<?php echo $row['hodID']?>"><?php echo $row['managementName']." ".$row['lastName'];?></option>
							<?php
							...
							while($row1 = mysqli_fetch_array($result1)){ ?> 
								...
								<option value="<?php echo $row1['managementID'];?>"><?php echo $row1['managementName']." ".$row1['lastName'];?></option>
		...
		<div class="modal-footer">
			<button  type="submit" 
			class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-info">Update Department</button>
		</div>
					...
					<div class="card-body row">
						...
						<div
							...
							while($row = mysqli_fetch_array($result)){ ?> 
								...
								<option value="<?php echo $row['managementID'];?>"><?php echo $row['managementName']." ".$row['lastName'];?></option>
...
<div class="modal-footer">
	<button 
	class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-info">Create Department</button>
</div>
