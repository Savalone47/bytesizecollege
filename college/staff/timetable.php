            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-10">
                                <a href="" class="backbtn" onclick="history.go(-1); return false;"
                                   style="margin-top: 0rem"><img src="data:image/png;base64,iVBORw0K
										...
										ZhxoYwAAAABJRU5ErkJggg==" width="20" height="20" class="gwt-Image CCCX1UC-m-e"
                                                                 aria-hidden="true">Back</a></div>

                            <div class="col-lg-2">
                                <div style="width: 85%; overflow: hidden;">    <?php
                                    if ($_SESSION['adminLevel'] === '1' || $_SESSION['adminLevel'] === '2' || $_SESSION['adminLevel'] === '5') { ?>
                                        <button type="button"
                                                class="btn-xs mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-default pull-right "
                                                data-toggle="modal" data-target="#myModal"
                                                style="text-transform: none;font-size: 14px;">Add Lessons<i
                                                    class="material-icons" style="color: #36C6D3">add</i><span
                                        ...
                                        <button type="button"
                                                ...
                                                style="text-transform: none;font-size: 14px;">Add extra Lessons<i
                                                    class="material-icons" style="color: #36C6D3">add</i><span
                                                    class="mdl-button__ripple-container"></button>
                                        <?php
                                    } ?></div>
                    ...
                    <input type="hidden" id="classID" value="<?= $_GET['classID'] ?? 0 ?>">
                            ...
                            <div class="card-head">
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="extra_lessons.php">
                                        <button type="button"
                                                class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-default pull-right "
                                                style="text-transform: none;font-size: 14px; background-color: transparent !important; border: none;box-shadow: none;text-decoration: underline;color: #888888;">
                                            View extra Lessons<span class="mdl-button__ripple-container"></button>
                                    </a>
                                ...
                                <header>
									...
									where lectureAssigns.lectureID = '" . $_SESSION['adminID'] . "'";
                                            ...
                                            while ($row8 = mysqli_fetch_array($query8)) { ?>
                                                ...
                                                <option value="<?php
                                                echo $row8['coursesID'] ?>"><?php
                                                    echo $row8['courseName'] ?></option>
                                        ...
                                        if ($_SESSION['adminLevel'] == '1' || $_SESSION['adminLevel'] == '2') {
                                            $sql7 = "SELECT DISTINCT departmentID,coursesID,courseName,departmentName  FROM courses 
...
//                                            var_dump($sql7);die;
                                            ...
                                            while ($row7 = mysqli_fetch_array($query7)) {
                                                ...
                                                <option value="<?php
                                                echo $row7['coursesID'] ?>"><?php
                                                    echo $row7['courseName'] . " (" . $row7['departmentName'] . ")" ?></option>
...
where department.hodID = '{$_SESSION['adminID']}'";
                                ...
                                <span style="text-align: center">Time Table</span>
                        ...
                        <div class="col-lg-12 p-t-20">
                            ...
                            <select class="mdl-textfield__input" name="moduleID">
                                ...
                                while ($rowlite = mysqli_fetch_array($querylite)) {
                                    ...
                                    <option value="<?php
                                    echo $rowlite['moduleID']; ?>"><?php
                                        echo $rowlite['moduleName'] . ' ' . $rowlite['moduleName']; ?></option>
                                    <?php
                                } ?>
