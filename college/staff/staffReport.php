...
<ul class="nav nav-tabs">
  <li class="active"><a href="studentReport.php" class="btn btn-success">Student Report</a></li>
  <li><a  href="#" class="btn btn-info" >Staff Report</a></li>
</ul>
                  <header></header>
                ...
                <div id="tab1" class="tab-pane active">
                  <table id="exportTable" class="display ">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $row['managementName'];?></td>
                        <td><?php echo $row['managementEmail'];?></td>
                        <td><?php echo $row['dateOfBirth'];?></td>
                        <td><?php echo $row['managementContact'];?></td>
