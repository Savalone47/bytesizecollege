...
<button type="button" class="btn btn-primary mt-5 pull-right btn-sm" data-toggle="modal" data-target="#exampleModalCenter">
  Import Students
</button>
...
<div class="card-footer" >
  <form action="back/studentStatus.php" method="POST" enctype="multipart/form-data" class="btn-group ">
    <input type="hidden" name="id" value="
      ...
      <input type="hidden" name="email" value="<?php echo $row['studentEmail']?>">
        <button class="btn-group btn btn-rounded btn-success btn-xs">activate &nbsp;&nbsp;
    
          <i class="fa fa-toggle-off" aria-hidden="true"></i>
        </button>
      </form>
      <div class="btn-group btn btn-rounded btn-xs pull-right" id="delete" data-id="<?php echo $row['studentID'];?>">
              ...
              <div class="doctor-profile">
                ...
                <div style="text-align: left !important;">
                  <p style="font-size: 12px"><i class="fa fa-envelope"></i>&nbsp;&nbsp;
                    <a href="mailto:<?php echo $row['studentEmail']?>" target="_blank"> <?php echo $row['studentEmail']?></a></p>
