							...
							<div class="card-body ">
								...
								<div class="row">
									...
									while($row = mysqli_fetch_array($query)){
										...
										$sqlite = "SELECT * FROM learningMaterial where learningID='".$row['learningID']."' and deleteStatus=0";
											...
											<div class="card card-box">
												<div class="card-body no-padding ">
													<div class="doctor-profile">
														...
														<a target="_blank" href="<?php echo $row['link']?>&preview=<?php echo $rowlite['file']?>" preview>	<div class="profile-usertitle">
															...
															<div class="name-center">
																<div class="text">	<?php echo $rowlite['file']?></div><br>
															...
															<div class="profile-userbuttons">
																...
																if($_SESSION['adminLevel'] == '1'|| $_SESSION['adminLevel']== '2'){
																	...
																	$action = "back/deleteResourcesAdmin.php?id=".$row['moduleID'];

																}else{

																	$action = "delete_resource.php?id=".$row['moduleID'];

																}
																?>
																<a onclick="return confirm('Are you sure you want to delete this?')" 
																href="<?php echo $action;?>">	<button class="btn btn-danger btn-xs">Delete</button></a>
															</div>
														</div>
													</div>
												</div>
