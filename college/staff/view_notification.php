                            ...
                            <div class="notification-list notification-list--unread">
                                <div class="notification-list_content">
                                    <div class="notification-list_img">
                                        <img src="management/<?= $admin['managementPhoto'] ?>" alt="user">
                                    </div>
                                    <div class="notification-list_detail">
                                        <p><b class="bold-muted underline"><?php
                                                echo $row['title'] ?></b></p>
                    ...
                    <div style="background: #fff;
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-6">
                                <h2><?php
                                    echo $row['title'] ?></h2>
                                <p style="font-size:10px;">Posted on: <?php
                                    echo date('d-m-Y', strtotime($row['time_stamp'])) ?>
                                    <br/><?php
