...
<table id="exportTable"
    ...
    if ($_POST['action'] == 'intake') {
        ...
        $part = (!empty($department) && $department !== 'all') ? "AND department.departmentName ='$department'" : "";
        $part1 = (!empty($course) && $course !== 'all') ? "AND courses.courseCode = '$course'" : "";
        $part2 = (!empty($intake) && $intake !== 'all') ? "AND courses.courseIntake = '$intake'" : "";
