				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title"><?php echo $row1['moduleName']?></div>
							</div>
					...
					<div class="state-overview">
						<div class="row">
							...
							$sql = "SELECT * FROM assignmentFeedback where moduleID='".$_GET['id']."' and studentID='".$_SESSION['adminID']."'";
							$query = mysqli_query($conn,$sql);
							...
							<div class="col-xl-3 col-md-6 col-12">
								...
								<div class="info-box bg-b-blue" data-toggle="modal" data-target="#tab<?php echo $row['id']?>">
									<span class=" "><i class="material-icons">assignment</i></span>
									
									<span class="info-box-text" style="color: #fff;">Assignment <?php echo $row['assignmentNo']?></span>	
									<!-- /.info-box-content -->
									<p>Marks:    <?php echo $row['marks']?>/<?php echo $row['']?></p>
									<!-- /.info-box -->
								</div>
							</div>
							<!---subject end-->
									...
									<div class="modal-content modal-info">
										...
										<div class="modal-body">
											...
											<form action="#" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
												<p>View Assignment:  &nbsp
												<a href="../img/<?php echo $row['assignment']?>">  <?php echo $row['assignment']?> jgdhdhf</a></p>
												
												<p>Module Name: <?php echo $row1['moduleName']?></p>
											

													
												
												<p>Assignment No: <?php echo $row['assignmentNo']?></p>
						...
						<?php }?>
						   ...
						   <div class="col-xl-3 col-md-6 col-12">
						   	 <a href="assignment_results.php">
								<div class="info-box bg-b-pink">
									<span class=" "><i class="material-icons">done_all</i></span>
									
									<span class="info-box-text" style="color: #fff;">Assignment Results</span>	
									<!-- /.info-box-content -->
