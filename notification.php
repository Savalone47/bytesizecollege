                    ...
                    <div class="col-lg-4">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content text-center">
                                ...
                                <a href="#"><i class="far fa-calendar"></i><?=date("Y-F-d H:i",strtotime($row['time_stamp']));?></a>

                                <a  class="blog-one__link" data-toggle="modal" data-target="#Modal-overflow<?=$row['id'];?>">Read More</a>
                            </div>
...
<div class="modal fade modal-flex" id="Modal-overflow<?=$row['id'];?>" tabindex="-1" role="dialog" style="z-index: 1050; display: none;" aria-hidden="true">
