                    ...
                    <div class="col-xl-6">
                        <div class="about-two__content" >
                            <div class="block-title text-left">
                                <h2 class="block-title__title" style="color:#18478c;">Full-Time Courses</h2><!-- /.block-title__title -->
                            </div><!-- /.block-title -->
 ...
 <section class="course-one course-one__teacher-details home-one">
     ...
     <h2 class="course-one__title"><a href="courseDetails.php?id=<?php echo $row['moduleID']?>" ><?php echo $row['moduleName']; ?></a></h2>
                                <!-- /.course-one__title -->
                        
                            
                                <a href="courseDetails.php?id=<?php echo $row['moduleID']?>&type=fulltime" class="course-one__link">See Preview</a><!-- /.course-one__link -->
